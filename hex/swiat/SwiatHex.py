...
from hex.LabelHex import LabelHex
...
class SwiatHex(LabelHex):
    ...
    def mousePressEvent(self, event: QMouseEvent):
        x = int((event.x()-95/2)/42)
        y = int((event.y() - 95/2 - (self.x_size - x)*23)/47)
